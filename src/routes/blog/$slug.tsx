...
const posts = [
  ...
  { slug: "digital-operations-tools-kenya", title: "Digital Operations Tools: How to Run Your Business Without Chaos", excerpt: "A practical rundown of the tools that keep Kenyan businesses organized — project management, communication, files, and automation.", tag: "Business", date: "2026-08-03", readTime: "6 min", published: false },
  { slug: "blog-management-tools", title: "How to Manage a Business Blog: Tools for Planning, Writing, and Publishing", excerpt: "The complete toolkit for running a business blog — from content calendars and drafting to scheduling and analytics.", tag: "Content Marketing", date: "2026-08-05", readTime: "6 min", published: false },
  { slug: "content-calendar-kenya", title: "Build a Content Calendar: Plan a Month of Posts in One Afternoon", excerpt: "A simple, repeatable method for planning a month of content in one sitting — the exact framework we use with clients.", tag: "Content Marketing", date: "2026-08-07", readTime: "5 min", published: false },
  { slug: "business-automation-kenya", title: "Automation for Small Businesses: Reclaim 10 Hours a Week", excerpt: "The highest-value workflows to automate first — leads, invoicing, support, and content — with tools that cost less than a staff member.", tag: "AI Marketing", date: "2026-08-10", readTime: "6 min", published: false },
];
...
const postContent = {
  ...
  "social-media-marketing-kenya": [
    ...
    { type: "p", text: "Strategy: Thought leadership content, case studies, team insights. Post 2-3x/week. Engage with comments." },
  ...
  "digital-operations-tools-kenya": [
    { type: "p", text: "Running a business online means juggling a lot: clients, content, invoices, emails, and meetings. Most owners don't fail from lack of effort. They drown in scattered tools and lost information." },
    { type: "p", text: "The fix is a simple, consistent operations stack. Here's the toolkit we recommend to businesses in Nairobi and across East Africa." },
    { type: "h2", text: "Start With Your Stack, Not Your Apps" },
    { type: "p", text: "Before adding tools, decide what you need to manage: projects, communication, files, and repetitive tasks. One tool per job. That's the whole system." },
    { type: "note", text: "Rule of thumb: if a tool doesn't replace something you already do, skip it. More apps mean more tabs, not more productivity. Most of these tools have free tiers that cover a small team, with paid plans from around KES 1,000-3,000 per month." },
    { type: "h2", text: "Project and Task Management" },
    { type: "p", text: "Trello, Asana, and ClickUp all work well. Trello is the easiest to learn. Asana handles bigger teams. Notion works if you want notes and tasks in one place." },
    { type: "ul", items: ["One board per major client or project", "A shared calendar for deadlines", "A weekly review: what moved, what's stuck"] },
    { type: "h2", text: "Communication" },
    { type: "p", text: "Email is for formal records. Chat is for quick answers. WhatsApp Business is the default for client communication in Kenya, but internal teams benefit from Slack or Microsoft Teams, where conversations stay searchable." },
    { type: "p", text: "Set one simple rule: important decisions happen in writing, not in scattered voice notes." },
    { type: "h2", text: "Files and Documents" },
    { type: "p", text: "Google Workspace is the most practical starting point: Docs, Sheets, Drive, and Gmail in one place with a generous free tier." },
    { type: "ul", items: ["One shared folder structure: Clients, Finance, Marketing, Operations", "Clear file naming so nothing is ever 'final final v3'", "Sheets for simple financials until you outgrow them"] },
    { type: "h2", text: "Automation" },
    { type: "p", text: "Zapier and Make connect your apps so data moves without you. When someone fills your website form, it can create a lead row in a sheet, send a notification, and book a follow-up call." },
    { type: "note", text: "Start with one workflow that saves you an hour a week. Automate that before touching anything else." },
    { type: "h2", text: "Scheduling and Meetings" },
    { type: "p", text: "Calendly or Google Calendar booking pages end the back-and-forth of finding meeting times. Share your link, clients pick a slot, and reminders go out automatically." },
    { type: "h2", text: "What to Adopt First" },
    { type: "ul", items: ["Week 1: pick a project tool and move every open task into it", "Week 2: set up shared folders and naming rules", "Week 3: automate one repetitive workflow", "Week 4: review what stuck and drop what didn't"] },
    { type: "p", text: "Tools don't create discipline. But the right stack makes good habits easy and bad ones obvious." },
    { type: "blockquote", text: "The goal isn't more tools. It's fewer places where information can get lost." },
  ],
  "blog-management-tools": [
    { type: "p", text: "A blog only works if you can run it consistently. Most businesses start strong, publish five posts, then stall because the process is messy." },
    { type: "p", text: "The fix is a simple toolchain that covers four jobs: planning, writing, publishing, and measuring. Here's how to set it up." },
    { type: "h2", text: "Planning: The Content Calendar" },
    { type: "p", text: "Notion and Google Sheets are the two most common choices. Notion gives you a proper database with statuses. Sheets is free and everyone already knows it." },
    { type: "ul", items: ["Columns for: title, keyword, status, publish date, author", "Plan one month ahead, minimum", "Batch topics by theme so writing sessions stay focused"] },
    { type: "h2", text: "Writing and Editing" },
    { type: "p", text: "Google Docs is the workhorse: comments, suggestions, and version history make editing painless. Grammarly catches the obvious errors before a human has to." },
    { type: "p", text: "If you use AI for drafts, treat it as a junior writer. It produces the first version; a human adds the voice, examples, and final judgment." },
    { type: "note", text: "Keep a short style guide in the same folder as your calendar: tone, banned words, how you address the reader. It keeps every post sounding like the same brand." },
    { type: "h2", text: "Publishing: The CMS" },
    { type: "p", text: "WordPress powers a large share of business blogs and handles plugins, SEO, and scheduled publishing out of the box. Ghost is a cleaner, faster option focused purely on writing." },
    { type: "p", text: "For businesses that want speed and zero maintenance, a custom site on a modern stack publishes with a simple push to the repository. No dashboard to log into, no updates to babysit." },
    { type: "h2", text: "Scheduling and Distribution" },
    { type: "p", text: "Buffer and Hootsuite schedule social posts in advance. Meta Business Suite does it free for Facebook and Instagram. Mailchimp or Substack can turn each post into an email newsletter." },
    { type: "ul", items: ["Write one week, schedule the next", "Turn each post into three social snippets", "Send the newsletter the day the post goes live"] },
    { type: "h2", text: "Images" },
    { type: "p", text: "Canva handles graphics. Pexels and Pixabay supply free stock photos. Keep a folder of brand templates so every post image looks consistent." },
    { type: "h2", text: "Measuring" },
    { type: "p", text: "Google Analytics 4 shows which posts bring traffic. Google Search Console shows which keywords you rank for. Check both once a month, then write more of what works." },
    { type: "p", text: "A blog that is planned, published, and measured on a rhythm beats a brilliant blog that publishes whenever someone remembers." },
    { type: "blockquote", text: "Consistency is the strategy. The tools just make consistency possible." },
  ],
  "content-calendar-kenya": [
    { type: "p", text: "The hardest part of content marketing isn't writing. It's deciding what to write, then remembering to do it. A content calendar solves both." },
    { type: "p", text: "Here's the exact process we use with clients. You can finish it in one afternoon, including the coffee break." },
    { type: "h2", text: "Step 1: List What Your Customers Ask" },
    { type: "p", text: "Write down every question customers have asked you in the last three months. These are your best post ideas, already proven by real interest." },
    { type: "p", text: "A Nairobi logistics company built an entire month of content from one recurring question: how long does delivery actually take?" },
    { type: "h2", text: "Step 2: Map Each Idea to a Goal" },
    { type: "ul", items: ["Awareness posts: teach something useful, no hard sell", "Trust posts: behind the scenes, team, process", "Conversion posts: offers, comparisons, case studies"] },
    { type: "p", text: "A healthy month has mostly awareness, some trust, and one or two conversion posts." },
    { type: "h2", text: "Step 3: Assign One Slot Per Idea" },
    { type: "p", text: "Open your calendar tool and put one post in each slot. Many businesses use a simple pattern: Mondays for how-to content, Wednesdays for opinions, Fridays for news and updates." },
    { type: "h2", text: "Step 4: Write Titles and Keywords Now" },
    { type: "p", text: "Don't leave titles for later. A title written today forces you to commit to the angle. Add the target keyword next to it, so every post has a purpose beyond filling a slot." },
    { type: "h2", text: "Step 5: Batch the Writing" },
    { type: "p", text: "Book two half-day sessions per month and write four posts per session. Batching beats one hour here and there, because your brain stays in writing mode." },
    { type: "note", text: "You don't need a fancy tool. A Google Sheet with columns for date, title, keyword, status, and notes is enough to run a serious content engine." },
    { type: "h2", text: "The Rhythm That Matters" },
    { type: "p", text: "One post per week, every week, beats five posts one month and silence the next. Readers and Google both reward rhythm." },
    { type: "p", text: "Set the calendar once, follow it, and review every 30 days. That's the whole system." },
    { type: "blockquote", text: "A plan you follow is worth more than a perfect plan you abandon." },
  ],
  "business-automation-kenya": [
    { type: "p", text: "Every business has tasks that happen on repeat: sending the same reply, updating the same spreadsheet, chasing the same unpaid invoice. Each one takes five minutes. Together they eat a full day every week." },
    { type: "p", text: "Automation is how you get those hours back. Here are the workflows we automate first for clients, in order of impact." },
    { type: "h2", text: "1. Lead Capture and Follow-Up" },
    { type: "p", text: "When a website form is submitted, most businesses copy the details into a spreadsheet by hand and reply hours later. By then the lead is cold." },
    { type: "p", text: "Zapier or Make can take that submission, add it to a sheet or CRM, and send an instant acknowledgment. Follow-up speed alone lifts conversion." },
    { type: "h2", text: "2. Invoicing and Payment Reminders" },
    { type: "p", text: "Tools like Zoho Invoice or Wave send the invoice, chase it automatically, and flag late payers. No more awkward messages asking for money. The tool does the tracking, you keep the relationship." },
    { type: "h2", text: "3. Customer Support Replies" },
    { type: "p", text: "A simple chatbot or WhatsApp Business automated reply answers the top ten questions instantly: prices, hours, location, delivery times. Real people handle the rest." },
    { type: "note", text: "Automation handles the repetitive 80%. It frees your team for the conversations that actually need a human." },
    { type: "h2", text: "4. Content Distribution" },
    { type: "p", text: "Write once, publish everywhere. Scheduling tools post to social channels, a newsletter tool emails your list, and the whole thing runs while you sleep." },
    { type: "h2", text: "5. Data Entry and Reporting" },
    { type: "p", text: "A workflow that moves numbers from one app to another removes transcription errors. Weekly sales reports can assemble themselves from your payment and point-of-sale data." },
    { type: "h2", text: "How to Start Without Breaking Anything" },
    { type: "ul", items: ["List your three most repetitive weekly tasks", "Pick the one with the clearest steps and the biggest time cost", "Map the steps in plain language before touching a tool", "Build the smallest version, test it with real data, then expand"] },
    { type: "p", text: "Start small. A workflow that saves one hour a week and runs reliably beats five workflows that save ten hours and break on Friday." },
    { type: "blockquote", text: "Automate the boring parts, and the interesting parts get more of your attention." },
  ],
};  // close postContent
